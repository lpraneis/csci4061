...
// complete but are waiting for a wait() call from their parent
// process before then can terminate. These will have staus 'Z' in
// process listings such as with top.  
// 
