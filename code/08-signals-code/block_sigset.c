// bloc_sigset.c: demonstrate setting up a set of signals and blocking
// all of them.  This causes signals to not be delievered. After 5
// seconds the default signal disposition is restored and any pending
// signals are delivered to the process.
//
